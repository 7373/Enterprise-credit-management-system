...
/**
 * 描述:    nd_environment_evaluate_info 对应的Service接口实现类.<br>
 *
 * @author framework generator
 * @date 2017年06月30日
 */
@Service
public class NdEnvironmentEvaluateInfoServiceImpl extends MyBatisServiceSupport implements INdEnvironmentEvaluateInfoService {
	/**
	 * 获取数据 @author rah
	 */
	@Autowired
	NdEnvironmentEvaluateInfoMapper ndEnvironmentEvaluateInfoMapper;
	@Override
	public List<NdEnvironmentEvaluateInfo> selectList(PageRequest request) throws Exception {
