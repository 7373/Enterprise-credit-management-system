 ...
 */
@Controller
@RequestMapping("/gateway/system/sysrole")
public class GateWaySysRoleController extends BaseController {
    @Autowired
    ...
    public String list() throws Exception {
        return "gateway/system/sysrole/list";
    }
    ...
    public PageResponse<SysRole> listJSON(PageRequest request) throws Exception {
        List<SysRole> data = sysRoleService.queryPage(request, Constants.GATEWAY_USER_TYPE);
    ...
    public ModelAndView show(String id) throws Exception {
        ModelAndView view = new ModelAndView("gateway/system/sysrole/edit");
