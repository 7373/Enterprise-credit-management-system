 ...
 */
@Controller
@RequestMapping("/gateway/system/sysuser")
public class GateWaySysUserController extends BaseController {
    private final static Logger logger = LoggerFactory.getLogger(GateWaySysUserController.class);
    @Autowired
    ...
    public String list() throws Exception {
        return "gateway/system/sysuser/list";
    }
    ...
    public ModelAndView show(String uid) throws Exception {
        ModelAndView view = new ModelAndView("gateway/system/sysuser/edit");
        //所有角色信息
        view.addObject("allRoles", sysRoleService.selectAllByRoleType(Constants.GATEWAY_USER_TYPE));
