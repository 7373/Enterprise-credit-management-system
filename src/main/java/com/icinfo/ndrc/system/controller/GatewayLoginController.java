...
public class GatewayLoginController extends BaseController {
    private final static Logger logger = LoggerFactory.getLogger(GatewayLoginController.class);
    ...
    @ResponseBody
    public ModelAndView doEnGateWayBackIndex(HttpSession session) throws Exception {
    	ModelAndView mv = new ModelAndView("gateway/system/index");
...
//            }
            ...
            sysUser.setUserType(Constants.GATEWAY_USER_TYPE);
