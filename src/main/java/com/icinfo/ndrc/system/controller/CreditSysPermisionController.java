 ...
 */
@Controller
@RequestMapping("/credit/system/syspermision")
public class CreditSysPermisionController extends BaseController {
    @Autowired
    ...
    public String list() throws Exception {
        return "credit/system/syspermision/list";
    }
    ...
    public AjaxResult listJSON() throws Exception {
        //查询所有权限
        List<SysPermision> permisions = sysPermisionService.selectAllByPermisionSysType(Constants.CREDIT_USER_TYPE);
        //构造ztree节点数据
    ...
    public ModelAndView show(String id, String sid) throws Exception {
        ModelAndView view = new ModelAndView("credit/system/syspermision/edit");
