...
/**
 * 描述:    temp_office_unit_base_info 对应的Service接口.<br>
 *
 * @author framework generator
 * @date 2017年06月29日
 */
public interface ITempOfficeUnitBaseInfoService extends BaseService,IBatchService {

	/**
	 * 读取Excel存取
	 * Copyright© 2003-2017 浙江汇信科技有限公司, All Rights Reserved.
	 * @author  ranah
	 * @when   2017年6月29日下午4:09:08
	 * @param depCode
	 * @param sheet
	 * @param bacthNO
	 * @return
