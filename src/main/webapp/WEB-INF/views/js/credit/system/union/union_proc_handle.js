			...
			function initDataTable() {
				table = dataTable
						.load({
							...
							ajax : {
								url : '/credit/ndunion/info/proList.json',
								type : 'post',
								// contentType:"json",
								data : function(d) {
							...
							columns : [ 
							     ...
							     {data : 'contactsName',className : 'center'},
							     {data : 'contactsTel',className : 'center'},
							     {data : 'contactsMail',className : 'center'}
							     ],
							columnDefs : [ 
								{
									targets : 1,
									render : function(data, type, row, meta) {
										return "<a href='javascript:void(0)' id='' class='mr10 look' value=''>处理</a>";
									}
								} 
							]
						})
