...
var _exportData = function ( dt, inOpts )
{
	...
	for ( var i=0, ien=rows ; i<ien ; i++ ) {
		...
		for ( var j=0 ; j<columns ; j++ ) {
			...
			//++++++++++++++++++++++++++++++++++++++++++ add by dingxiaohong 20170105
			if(typeof cells[ cellCounter ] === 'string' && cells[ cellCounter ].indexOf('...')!== -1){
				cells[ cellCounter ] = $(cellNodes[ cellCounter ]).attr('title') || $(cellNodes[ cellCounter ]).text();
			}
			//=============================================================================
