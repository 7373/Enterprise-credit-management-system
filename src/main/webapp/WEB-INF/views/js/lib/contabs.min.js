$(function () {
    ...
    function c() {
        ...
        if(k && $('.J_menuTab').length > 6 ){
            try {
                var iframe = $(".J_mainContent").find('iframe.J_iframe:last')[0];
                if (iframe) {
            ...
            $(".J_menuTabs .page-tabs-content .J_menuTab:last").remove();
            // $(".J_mainContent").find('iframe.J_iframe:last').remove();
        }
        $('.metismenu a,.metismenu li.list-item').removeClass('cur');
        $(this).addClass('cur');
        $(this).parents('li.list-item').addClass('cur');
        if (k) {
            var p = '<a href="javascript:;" class="active J_menuTab" data-id="' + o + '" title="'+ l +'"><em>' + l + ' </em><i class="fa close xbt-icon"></i><i class="fa refresh active js-refresh"></i></a>';
            $(".J_menuTab").removeClass("active");
            $(".J_menuTab").find('.js-refresh').removeClass('active');
            var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
            $(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").find('iframe.J_iframe:first').after(n);
            $(".J_menuTabs .page-tabs-content .J_menuTab:first").after(p);
            g($(".J_menuTab.active"))
        }
        return false
    }
    ...
    function h(e) {
        ...
        if ($(this).parents(".J_menuTab").hasClass("active")) {
            ...
            if ($(this).parents(".J_menuTab").prev(".J_menuTab").size()) {
                ...
                $(this).parents(".J_menuTab").prev(".J_menuTab:last").find('.js-refresh').addClass("active");
                $(".J_mainContent .J_iframe").each(function () {
                    if ($(this).data("id") == k) {
                        $(this).show().siblings(".J_iframe").hide();
                        return false
