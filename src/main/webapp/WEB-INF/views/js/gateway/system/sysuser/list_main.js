require(['component/iframeLayer',
    ...
    function initDataTable() {
        ...
        table = dataTable.load({
            ...
            el: '#user-table',
            ajax: {
                url:'/gateway/system/sysuser/list.json',
                data:function(d){
        ...
        util.bindEvents([{
            ...
            handler: function () {
                layer.dialog({
                                                      title: '新增用户',
                    area: ['628px', '450px'],
                    content: '/gateway/system/sysuser/show',
            ...
            handler: function () {
                ...
                layer.dialog({
                    title: '编辑用户',
                    area: ['628px', '450px'],
                    content: '/gateway/system/sysuser/show?uid=' + data.uid,
                    callback: function (data) {
                        if (data.reload) {
                            table.ajax.reload();
                        }
            ...
            handler: function () {
                ...
                layer.confirm('确定要删除吗?', {icon: 2, title: '提示'}, function (index) {
                    http.httpRequest({
                        url: '/gateway/system/sysuser/delete',
                        data: {uid: data.uid},
