...
<div class="main msgshow">
    <form id="submitForm" method="post">
        ...
        <input type="hidden" id="ndGrant.uid"   value="${ndGrant.uid}" />
        ...
        <table class="tablebox">
            ...
            <tr>
                ...
                <td><input type="text" id="graStartLine" name="graStartLine"
                           value="${ndGrant.graStartLineDesc}" onclick="laydate()" readonly="readonly" style="width:154px;height:26px;" /></td>
                <td></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" id="graDeadLine" name="graDeadLine"
                           value="${ndGrant.graDeadLineDesc}" onclick="laydate()" readonly="readonly" style="width:154px;height:26px;" /></td>
                <td></td>
            </tr>
        </table>
        <div class="btnCenter">
...
<script src="<c:url value='/js/credit/system/grant/credit_grant_add.js'/>"></script>
</body>
</html>