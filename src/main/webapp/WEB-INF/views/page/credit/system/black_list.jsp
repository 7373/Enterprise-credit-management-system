	...
	<div class="iframe-wrap">
		...
		<div class="form-panel">
			...
			<form id="qyRedBlackForm" class="form-box mb10">
					...
					<div class="form-item clearfix mr20">
						<div class="form-item clearfix">
							<div class="col-6">
								...
								<div class="col-5">
									<div class="ipt-box">
										<input type="text" class="ipt-txt clx" name="partyName"
											value="">
									</div>
								</div>
							</div>
				...
				<div class="mt15">
					<div class="center">
						<input type="button" id="qySearch" value="查询" class="btn mr20">
	...
	<div class="iframe-wrap">
		...
		<div class="form-panel">
			...
			<form id="grRedBlackForm" class="form-box mb10">
				...
				<input type="hidden" name="listType" value="b"> <input
					type="hidden" name="partyType" value="g">
				<div class="mt15">
					<div class="center">
