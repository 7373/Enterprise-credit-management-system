...
<div>
    ...
    <div class="comeback">
        ...
        <textarea name="messageReply" id="messageReply" cols="30" rows="10"></textarea>
    </div>
    <input type="hidden" name="uid" value="${ndrcCreditConsult.uid }" >
    <div class="mt10">
        <div class="center">
...
<script src="<c:url value='/js/gateway/biz/backstage/credit_consult_replay.js'/>"></script>
</body>
</html>