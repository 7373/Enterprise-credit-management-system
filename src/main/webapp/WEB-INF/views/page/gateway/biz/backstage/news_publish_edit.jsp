        ...
        <div class="form-list">
            <div class="form-item clearfix mr20">
                <div id="" class="col-12">
                    ...
                    <div class="col-11">
                        <div class="ipt-box">
                            <input type="text" class="ipt-txt js-name" name="title" value="${newsPublish.title}"/>
                        </div>
                    </div>
                                ...
                                <div class="ipt-box">
                                    <select id="type1Code" name="type1Code" class="">
                                        <c:forEach var="catalog1" items="${ndrcCatalog1List}">
      									<option <c:if  test='${catalog1.catalogCode==newsPublish.type1Code}' > selected </c:if> value="${catalog1.catalogCode}" uid="${catalog1.UID}" code="${catalog1.catalogName}" >${catalog1.catalogName}</option>
<%-- 											<option value="${catalog1.catalogCode}" uid="${catalog1.UID}" code="${catalog1.catalogName}" >${catalog1.catalogName}</option> --%>
<%-- 											<option >${catalog1.catalogName}</option> --%>
      									</c:forEach>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-4">
                            ...
                            <input type="hidden" id="type2CodeFlag"  value="${newsPublish.type2Code}" />
                            <div class="col-7">
                                <div class="ipt-box">
            ...
            <div class="form-item clearfix mr20">
            <input type="hidden"  name="uid" value="${newsPublish.UID}"/>
            	...
            	<ul>
            		<li>
            			...
            			<div class="file-box col-11">
            				<input type="button" id="uploadname" value="图片上传" class="upload btn-mad btn-bg-bule">
            				<span id="fileBox">
            					<input type="file" id="btnFile" name="btnFile" class="file" >
            				</span>
...
<script src="<c:url value='/js/gateway/biz/backstage/news_publish_edit.js'/>"></script>
</body>
</html>