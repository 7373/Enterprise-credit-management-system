...
<div class="iframe-wrap">
    <div class="form-panel">
        ...
        <div class="template-down mb30">模板下载：交通局20170509.xls</div>
        <div class="complaint-files-select clearfix">
            ...
            <div class="file-box mr5">
                <span><input type="file" id="btnFile" class="btnFile  w-80" name="btnFile"></span>
                <button type="submit" class="fl btn btn-ms w-80">选择文件</button>
            </div>
        </div>
        ...
        <div class="notes">
            ...
            <p>5、日期型的数据，必须为日期格式或者yyyy-mm-dd、yyyy/mm/dd、yyyy.mm.dd格式的文本类型。</p>
