...
<div class="xyla-nav-wrap xyla-nav-bg">
    <ul class="xyla-nav">
        ...
        <li><a class="active" href="javascript:void(0);">信用研究</a></li>
...
<div class="wrap1000 mt20 clearfix">
    <div class="nav-left fl">
        ...
        <ul class="nav-left-list js-nav-list">
            <li><a href="javascript:void(0);"><img src="/img/gateway/nav_left_arr.png"> 信用研究</a></li>
            <li><a class="nav-cur" href="javascript:void(0);"><img src="/img/gateway/nav_left_arr.png">视频资料</a></li>
        </ul>
    </div>
    <div class="cont-right fr">
        <div class="cont-title clearfix">
            <div class="fl cont-title-text">视频资料</div>
        ...
        <div class="video-data center clearfix">
            <ul>
                <li>
                    <a href="#">
                        <img src="/img/gateway/video_01.jpg">
                        <p>社会信用系统建设</p>
                    </a>
                </li>
                <li>
