...
<div class="xyla-nav-wrap xyla-nav-bg">
    <ul class="xyla-nav">
        ...
        <li><a class="active" href="javascript:void(0);">发布平台</a></li>
...
<div class="wrap1000 mt20 clearfix">
    <div class="nav-left fl">
        ...
        <ul class="nav-left-list js-nav-list">
            <li><a href="javascript:void(0);"><img src="/img/gateway/nav_left_arr.png"> 七天双公示</a></li>
            <li><a href="javascript:void(0);"><img src="/img/gateway/nav_left_arr.png">信用红名单</a></li>
            <li><a href="javascript:void(0);"><img src="/img/gateway/nav_left_arr.png">信用黑名单</a></li>
            <li><a class="nav-cur" href="javascript:void(0);"><img src="/img/gateway/nav_left_arr.png">部门公示</a></li>
        </ul>
    </div>
    <div class="cont-right fr">
        <div class="cont-title clearfix">
            <div class="fl cont-title-text">部门公示</div>
        ...
        <ul class="cont-list cont-list-fl fr">
            <li><a><span>></span>杭州财税网：税务稽查</a></li>
            <li><a><span>></span>杭州财税网：税务稽查</a></li>
            <li><a><span>></span>杭州财税网：税务稽查</a></li>
            <li><a><span>></span>杭州财税网：税务稽查</a></li>
            <li><a><span>></span>杭州财税网：税务稽查</a></li>
