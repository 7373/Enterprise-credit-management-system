...
<div class="wrap1000 mt20 clearfix">
    <div class="nav-left fl">
        ...
        <ul class="nav-left-list js-nav-list">
            <li><a class="nav-cur" href="javascript:void(0);"><img src="/img/gateway/nav_left_arr.png"> 信用咨询</a></li>
            <li><a href="javascript:void(0);"><img src="/img/gateway/nav_left_arr.png">信用申诉</a></li>
    ...
    <div class="cont-right fr">
        ...
        <form id="" name="" method="" action="">
            <div class="credit-info pl52">
                <ul>
                    <li><label class="w-78"><span>*</span>真实姓名：</label><input type="text"></li>
                    <li><label class="w-78">职业：</label><input type="text"></li>
                    <li><label class="w-78">联系电话：</label><input type="text"></li>
                    <li><label class="w-78">联系邮箱：</label><input type="text"></li>
                    <li>
                        <label class="w-78 vertical10">留言类型：</label><div class="select-box">
                        <select class="select">
                    ...
                    <li><label class="w-78"><span>*</span>留言标题：</label><input class="w-600" type="text"></li>
                    <li><label class="w-78"><span>*</span>留言内容：</label><textarea class="textarea-message" rows="10"></textarea></li>
                    <li>
                        <label class="w-78">验证码：</label><input class="w-60" type="text">
            ...
            <div class="btn-group center">
                ...
                <input class="w-90 fs16 btn-sub btn-bg-bule" type="reset" value="重置">
            </div>
        </form>
    </div>
</div>
